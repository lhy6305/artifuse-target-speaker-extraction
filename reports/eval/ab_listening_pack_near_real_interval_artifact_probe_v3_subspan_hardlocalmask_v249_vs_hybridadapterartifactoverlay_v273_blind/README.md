...
- manifest: `data/probes/near_real_interval_artifact_probe_v3_subspan_manifest.jsonl`
- A: `hardlocalmask_v249` -> `experiments/checkpoints/baseline_stft_mask_stage2_legacy_transient_leakguard_probe_v249_v240_hardlocalmask_v1_ft1/best.pt`
- B: `hybridadapterartifactoverlay_v273` -> `experiments/checkpoints/baseline_stft_mask_stage2_legacy_transient_leakguard_probe_v273_v249_hybridadapterartifactoverlay_v1_ft1/best.pt`
